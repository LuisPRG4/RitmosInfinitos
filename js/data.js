// --- NUEVA ESTRUCTURA PARA MÚLTIPLES PLAYLISTS ---
    const allPlaylists = {
        ...
        "Recomendaciones Estela - Relajarse": [
        {
            title: 'Song of the Wind',
            artist: 'Chillout Music Zone',
            src: 'audio/Musica Relajante/Song of the Wind.mp3', // Ajusta la ruta y el nombre del archivo si es diferente
            artwork: 'img/recommendations/jazz_suave.jpg' // Esta será la imagen de la tarjeta o del primer tema
        },
        {
            title: 'Bossa Nova Sunset',
            artist: 'Bossa Nova Collection',
            src: 'audio/Musica Relajante/Bossa Nova Sunset.mp3', // Ajusta la ruta
            artwork: 'img/recommendations/jazz_suave.jpg'
        }
        // Puedes añadir más canciones aquí para esta playlist
    ],
    "Recomendaciones Estela - Salsa": [
        {
            title: 'La Rebelión',
            artist: 'Joe Arroyo',
            src: 'audio/2. Salsa/1. Recomendaciones de Estela/La Rebelion.mp3', // Ajusta la ruta y el nombre del archivo
            artwork: 'img/recommendations/salsa_tropical.jpg'
        },
        {
            title: 'Gitana',
            artist: 'Willie Colon',
            src: 'audio/2. Salsa/1. Recomendaciones de Estela/Gitana.mp3', // Ajusta la ruta
            artwork: 'img/recommendations/salsa_tropical.jpg'
        }
        // Puedes añadir más canciones aquí para esta playlist
    ],
    "Recomendaciones Estela - Urbana": [
        {
            title: 'Calma (Remix)',
            artist: 'Pedro Capó & Farruko',
            src: 'audio/Urbano/Calma.mp3', // Ajusta la ruta y el nombre del archivo
            artwork: 'img/recommendations/energia_urbana.jpg'
        },
        {
            title: 'Otra Vez',
            artist: 'Zion & Lennox ft. J Balvin',
            src: 'audio/Urbano/Otra Vez.mp3', // Ajusta la ruta
            artwork: 'img/recommendations/energia_urbana.jpg'
        }
        
    ],

    'Hansel Camacho': [ // HANSEL CAMACHO
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/1. A Ellos.mp3',
                title: 'A Ellos',
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/2. Amor A Distancia.mp3',
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/3. Creo En Ti.mp3',
                title: 'Creo En Ti',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/4. Herida De Amor.mp3',
                title: 'Herida De Amor',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },

            {
                src: 'audio/2. Salsa/9. Hansel Camacho/5. La Mala Fe.mp3',
                title: 'La Mala Fe',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/6. No Es Coincidencia.mp3',
                title: 'No Es Coincidencia',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },

            {
                src: 'audio/2. Salsa/9. Hansel Camacho/7. Rey Del Rio.mp3',
                title: 'Rey Del Rio',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/8. Seductora.mp3',
                title: 'Seductora',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },
            ...
            {
                src: 'audio/2. Salsa/9. Hansel Camacho/9. Tu Fidelidad De Qué Me Sirve.mp3',
                title: 'Tu Fidelidad De Qué Me Sirve',
                artist: 'Hansel Camacho',
                artwork: 'img/Caratulas/Salsa/Hansel Camacho.jpg'
            },
        ...
        "Jerry Rivera": [
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/1. Ahora Que Estoy Solo.mp3',
                title: 'Ahora Que Estoy Solo',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/2. Amor de Fotografía.mp3',
                title: 'Amor de Fotografía',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/3. Amor de Novela.mp3',
                title: 'Amor de Novela',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/4. Amor Mágico.mp3',
                title: 'Amor Mágico',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/5. Amores Como el Nuestro.mp3',
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/6. Bailando.mp3',
                title: 'Bailando',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/7. Cara de Niño.mp3',
                title: 'Cara de Niño',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/8. Casi un Hechizo.mp3',
                title: 'Casi un Hechizo',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/9. Corazon Roto.mp3',
                title: 'Corazon Roto',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/10. Cuenta Conmigo.mp3',
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/11. Desnúdate Mujer.mp3',
                title: 'Desnúdate Mujer',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/12. Dia Y Noche Pienso En Tio.mp3',
                title: 'Dia Y Noche Pienso En Ti',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/13. Digo Tu Nombre.mp3',
                title: 'Digo Tu Nombre',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/14. El Camionero.mp3',
                title: 'El Camionero',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/15. Loco de Amor.mp3',
                title: 'Loco de Amor',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/16. Loco Enamorado.mp3',
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/17. Magia.mp3',
                title: 'Magia',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/18. Me Estoy Enamorando.mp3',
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/19. Mi Libertad.mp3',
                title: 'Mi Libertad',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/20. Navegándote.mp3',
                title: 'Navegándote',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/21. No Hieras Mi Vida.mp3',
                title: 'No Hieras Mi Vida',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/22. No Me Puedes Dejar Así.mp3',
                title: 'No Me Puedes Dejar Así',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/23. Qué Hay de Malo.mp3',
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/24. Quién De Los Dos.mp3',
                title: 'Quién De Los Dos',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/25. Solo Pienso En Tí.mp3',
                title: 'Solo Pienso En Tí',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/26. Tal Vez.mp3',
                title: 'Tal Vez',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/27. Trebol De 4 Hojas.mp3',
                title: 'Trebol De 4 Hojas',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/28. Ya No Soy El Niño Aquel.mp3',
                title: 'Ya No Soy El Niño Aquel',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/29. Me Estoy Enloqueciendo Por Ti.mp3',
                title: 'Me Estoy Enloqueciendo Por Ti',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/30. La Cura.mp3',
                title: 'La Cura',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/31. Nada Sin Ti.mp3',
                title: 'Nada Sin Ti',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/32. Para Darte Fuego.mp3',
                title: 'Para Darte Fuego',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/33. Quiero Llenarte.mp3',
                title: 'Quiero Llenarte',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
            ...
            {
                src: 'audio/2. Salsa/11. Jerry Rivera/34. Separemos Nuestras Vidas.mp3',
                title: 'Separemos Nuestras Vidas',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },

            {
                src: 'audio/2. Salsa/11. Jerry Rivera/35. Tú Eres.mp3',
                title: 'Tú Eres',
                artist: 'Jerry Rivera',
                artwork: 'img/Caratulas/Salsa/Jerry_Rivera-Magia-CD.png'
            },
        ...
        "Heredero": [
            {
                src: 'audio/3. Carranga/1. Heredero/1. Coqueta.mp3',
                title: 'Coqueta',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/1. Coqueta.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/2. Aniversario.mp3',
                title: 'Aniversario',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/2. Aniversario.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/3. Aquella.mp3',
                title: 'Aquella',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/3. Aquella.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/4. Con Eucalito.mp3',
                title: 'Con Eucalito',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/4. Con Eucalito.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/5. De Pronto Ya Me Olvidó.mp3',
                title: 'De Pronto Ya Me Olvidó',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/5. De Pronto Ya Me Olvidó.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/6. El Divorciado.mp3',
                title: 'El Divorciado',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/6. El Divorciado.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/7. El Gavilán.mp3',
                title: 'El Gavilán',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/7. El Gavilán.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/8. Hasta El Sol.mp3',
                title: 'Hasta El Sol',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/8. Hasta El Sol.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/9. La Ley.mp3',
                title: 'La Ley',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/9. La Ley.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/10. Le Pregunté.mp3',
                title: 'Le Pregunté',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/10. Le Pregunté.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/11. Los Encargos De Mi Máma.mp3',
                title: 'Los Encargos De Mi Máma',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/11. Los Encargos De Mama.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/12. Me voy.mp3',
                title: 'Me voy',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/12. Me Voy.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/13. Muero Llorando.mp3',
                title: 'Muero Llorando',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/13. Muero Llorando.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/14. Ni Una Mirada.mp3',
                title: 'Ni Una Mirada',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/16. Ni Una Mirada.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/15. No Nací Pa Enamorar.mp3',
                title: 'No Nací Pa Enamorar',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/14. No Nací Pa Enamorar.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/16. Pero Te Quiero.mp3',
                title: 'Pero Te Quiero',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/15. Pero Te Quiero.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/17. Por Aquí Pasó Un Amor.mp3',
                title: 'Por Aquí Pasó Un Amor',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/17. Por Aquí Pasó Un Amor.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/18. Ranchero.mp3',
                title: 'Ranchero',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/18. Ranchero.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/19. Uy San Pedro.mp3',
                title: 'Uy San Pedro',
                artist: 'Heredero',
                artwork: 'img/Caratulas/Carranga/1. Heredero/19. Uy San Pedro.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/20. Coqueta (Remix).mp3',
                title: 'Coqueta (Remix)',
                artist: 'Heredero - Jessi Uribe',
                artwork: 'img/Caratulas/Carranga/1. Heredero/20. Coqueta Remix.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/21. Despechado.mp3',
                title: 'Despechado',
                artist: 'Heredero - Willy - Titanes',
                artwork: 'img/Caratulas/Carranga/1. Heredero/21. Despechado.jpg'
            },

            {
                src: 'audio/3. Carranga/1. Heredero/22. Sabor A Derrota.mp3',
                title: 'Sabor A Derrota',
                artist: 'Heredero',
        ...
        "Aleteo Beatz": [
...

            {
                ...
                title: 'Vibras',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/34.png'
            },
            ...
            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/41. Todo Eso Pa Lante.mp3',
                title: 'Todo Eso Pa Lante',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/41.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/42. Trompetazo 3.0.mp3',
                title: 'Trompetazo 3.0',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/42.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/43. Voces Factory Inc.mp3',
                title: 'Voces Factory Inc',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/43.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/44. BAILALO.mp3',
                title: 'Bailalo',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/44.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/45. EIFFEL.mp3',
                title: 'Eiffel',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/45.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/46. El Mosquito.mp3',
                title: 'El Mosquito',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/46.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/47. Hasta Abajo.mp3',
                title: 'Hasta Abajo',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/47.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/48. Sensación.mp3',
                title: 'Sensación',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/48.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/49. Tocando Tu Cuerpo.mp3',
                title: 'Tocando Tu Cuerpo',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/49.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/50. Vamos A Volar.mp3',
                title: 'Vamos A Volar',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/50.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/51. Dale Bass.mp3',
                title: 'Dale Bass',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/51.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/52. Calabria.mp3',
                title: 'Calabria',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/52.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/53. Diablo 2.0.mp3',
                title: 'Diablo 2.0',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/53.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/54. La Queso.mp3',
                title: 'La Queso',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/54.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/55. Silencio.mp3',
                title: 'Silencio',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/55.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/56. Sufrir.mp3',
                title: 'Sufrir',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/56.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/57. Toma Dale.mp3',
                title: 'Toma Dale',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/57.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/58. Usted Y Usted.mp3',
                title: 'Usted Y Usted',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/58.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/59. Diosa de Corazones.mp3',
                title: 'Diosa de Corazones',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/59.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/60. México.mp3',
                title: 'México',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/60.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/61. El Blum.mp3',
                title: 'El Blum',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/61.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/62. Mueve Esas Nalgas.mp3',
                title: 'Mueve Esas Nalgas',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/62.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/63. Noche Es De Perreo.mp3',
                title: 'Noche Es De Perreo',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/63.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/64. Saxo Fire.mp3',
                title: 'Saxo Fire',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/64.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/65. El Bajito Brasil.mp3',
                title: 'El Bajito Brasil',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/65.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/66. Guaracha Activa.mp3',
                title: 'Guaracha Activa',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/66.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/67. Dutch 2023.mp3',
                title: 'Dutch 2023',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/67.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/68. En Navidad 2023.mp3',
                title: 'En Navidad 2023',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/68.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/69. No Estás Deprimido.mp3',
                title: 'No Estás Deprimido',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/69.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/70. Disco Night.mp3',
                title: 'Disco Night',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/70.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/71. Halloween 2.0.mp3',
                title: 'Halloween 2.0',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/71.png'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/72. Cult Of Snap.mp3',
                title: 'Cult Of Snap',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/72.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/73. Guarachando 3.0.mp3',
                title: 'Guarachando 3.0',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/73.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/74. Halloween Chucky.mp3',
                title: 'Halloween Chucky',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/74.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/75. Helicóptero.mp3',
                title: 'Helicóptero',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/75.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/76. La Combi.mp3',
                title: 'La Combi',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/76.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/77. La Policía No ‘’Tik Tok‘.mp3',
                title: 'La Policía No ‘’Tik Tok‘',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/77.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/78. La Subida.mp3',
                title: 'La Subida',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/78.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/79. Muy Rico.mp3',
                title: 'Muy Rico',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/79.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/80. No Hay Pánico.mp3',
                title: 'No Hay Pánico',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/80.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/81. Noche De Brujas.mp3',
                title: 'Noche De Brujas',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/81.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/82. Pa Chile.mp3',
                title: 'Pa Chile',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/82.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/83. Rompe Bajos.mp3',
                title: 'Rompe Bajos',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/83.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/84. Salsa Guaracha Bass.mp3',
                title: 'Salsa Guaracha Bass',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/84.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/85. Salvaje.mp3',
                title: 'Salvaje',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/85.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/86. Satisfaction.mp3',
                title: 'Satisfaction',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/86.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/87. Sax Brutal.mp3',
                title: 'Sax Brutal',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/87.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/88. Set Halloween.mp3',
                title: 'Set Halloween',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/88.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/89. Siente la Musica.mp3',
                title: 'Siente la Musica',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/89.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/90. Suave.mp3',
                title: 'Suave',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/90.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/91. Suden El Weed.mp3',
                title: 'Suden El Weed',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/91.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/92. Suéltame El Saxo.mp3',
                title: 'Suéltame El Saxo',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/92.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/93. Suéltame Un Set.mp3',
                title: 'Suéltame Un Set',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/93.png'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/94. Suena Rico.mp3',
                title: 'Suena Rico',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/94.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/95. Toma Que Toma.mp3',
                title: 'Toma Que Toma',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/95.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/96. Tracatata.mp3',
                title: 'Tracatata',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/96.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/97. Trompeta Loca.mp3',
                title: 'Trompeta Loca',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/97.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/98. Trumpet Fire.mp3',
                title: 'Trumpet Fire',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/98.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/99. Tucutu.mp3',
                title: 'Tucutu',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/99.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/100. Ultra.mp3',
                title: 'Ultra',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/100.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/101. Voces.mp3',
                title: 'Voces',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/101.jpg'
            },

            {
                src: 'audio/1. Aleteo/2. Aleteo Beatz/102. What 🔥.mp3',
                title: 'What 🔥',
                artist: 'Aleteo Beatz',
                artwork: 'img/Caratulas/Aleteo/BEATZ/102.jpg'
            },
        ],
